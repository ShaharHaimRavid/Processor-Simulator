...
static void parse_args(int argc, char *argv[], core_files_t *core_files, mem_files_t *mem_files)
{
	...
	core_files[1].coretrace_path = GET_ARG(argc, argv, 12, "C:\\Users\\shaha\\OneDrive\\מסמכים\\ProcessorProject\\ProcessorSim\\example_files\\core1trace.txt");
	core_files[2].coretrace_path = GET_ARG(argc, argv, 13, "C:\\Users\\shaha\\OneDrive\\מסמכים\\ProcessorProject\\ProcessorSim\\example_files\\core2trace.txt");
	core_files[3].coretrace_path = GET_ARG(argc, argv, 14, "C:\\Users\\shaha\\OneDrive\\מסמכים\\ProcessorProject\\ProcessorSim\\example_files\\core3trace.txt");
	...
	core_files[1].dsram_path = GET_ARG(argc, argv, 17, "C:\\Users\\shaha\\OneDrive\\מסמכים\\ProcessorProject\\ProcessorSim\\example_files\\dsram1.txt");
	core_files[2].dsram_path = GET_ARG(argc, argv, 18, "C:\\Users\\shaha\\OneDrive\\מסמכים\\ProcessorProject\\ProcessorSim\\example_files\\dsram2.txt");
	core_files[3].dsram_path = GET_ARG(argc, argv, 19, "C:\\Users\\shaha\\OneDrive\\מסמכים\\ProcessorProject\\ProcessorSim\\example_files\\dsram3.txt");
	...
	core_files[1].tsram_path = GET_ARG(argc, argv, 21, "C:\\Users\\shaha\\OneDrive\\מסמכים\\ProcessorProject\\ProcessorSim\\example_files\\tsram1.txt");
	core_files[2].tsram_path = GET_ARG(argc, argv, 22, "C:\\Users\\shaha\\OneDrive\\מסמכים\\ProcessorProject\\ProcessorSim\\example_files\\tsram2.txt");
	core_files[3].tsram_path = GET_ARG(argc, argv, 23, "C:\\Users\\shaha\\OneDrive\\מסמכים\\ProcessorProject\\ProcessorSim\\example_files\\tsram3.txt");
	...
	core_files[1].stats_path = GET_ARG(argc, argv, 25, "C:\\Users\\shaha\\OneDrive\\מסמכים\\ProcessorProject\\ProcessorSim\\example_files\\stats1.txt");
	core_files[2].stats_path = GET_ARG(argc, argv, 26, "C:\\Users\\shaha\\OneDrive\\מסמכים\\ProcessorProject\\ProcessorSim\\example_files\\stats2.txt");
	core_files[3].stats_path = GET_ARG(argc, argv, 27, "C:\\Users\\shaha\\OneDrive\\מסמכים\\ProcessorProject\\ProcessorSim\\example_files\\stats3.txt");
}
